...
const createAndInit = (node, classToCreate) => {
...
export default () => {
    ...
    createAndInit(newsSourceList, SourcesList);
    createAndInit(newsSourceTitle, SourcesTitle);
    createAndInit(newsContainer, NewsList);
