...
var apiKey = exports.apiKey = '90e3266a077347219e896b2dec2ec141';

var defaultSource = exports.defaultSource = 'bbc-news';

var customImageUrl = exports.customImageUrl = 'http://bydesignvsm.com/wp-content/uploads/2015/06/Black-Background-HD-Wallpaper-24.jpg';

var dateOptions = exports.dateOptions = {
    year: 'numeric',
    month: 'short',
    day: 'numeric',
    timezone: 'UTC',
...
var _NewsList = __webpack_require__(330);
...
var NewsList = function () {
     ...
     */
    function NewsList(node, newsSourceControls, newsSourceTitle, initialSource) {
        var _this = this;
    ...
    _createClass(NewsList, [{
        ...
        key: 'render',
        value: function render(builtString) {
        ...
        value: function parseData(data) {
            return data.articles.reduce(function (prevString, item) {
        ...
        value: function buildUrl() {
            if (this.source && this.source.length > 0) {
                return 'https://newsapi.org/v2/top-headlines?sources=' + this.source + '&apiKey=' + _config.apiKey;
            }
        }
